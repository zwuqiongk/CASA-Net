...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk: int = 10, tal_topk2: int | None = None):  # model must be de-paralleled
        ...
        self.assigner = TaskAlignedAssigner(
            ...
            topk2=tal_topk2,
            estal=getattr(h, "estal", False),
            estal_min_assign=getattr(h, "estal_min_assign", 6),
            estal_spatial_tolerance=getattr(h, "estal_spatial_tolerance", 0.7),
            estal_threshold_scale=getattr(h, "estal_threshold_scale", 0.20),
            estal_base_threshold=getattr(h, "estal_base_threshold", 0.3),
            estal_small_threshold=getattr(h, "estal_small_threshold", 8),
        )
